# Automatic Match-End Detection — Design

**Date:** 2026-07-21
**Status:** Approved, ready for implementation planning
**Scope:** A standalone detector process that watches an OBS game-capture source and emits a
match-end event naming the winner. Consumed by the FGC Scoreboard control dashboard.
...
with `uv`. New repository, name `fgc-match-detector`.
